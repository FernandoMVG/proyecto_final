...
OUTPUT_APUNTES_FILENAME = "apuntes_clase_final.md" # <--- AÑADIDO/CONFIRMADO
OUTPUT_APUNTES_PATH = os.path.join(BASE_PROJECT_DIR, "output", OUTPUT_APUNTES_FILENAME) # <--- AÑADIDO/CONFIRMADO
